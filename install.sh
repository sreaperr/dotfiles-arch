...
if ! command -v paru &>/dev/null; then
    ...
    git clone https://aur.archlinux.org/paru.git "$HOME_DIR/paru-src" || {
        echo "Error: no se pudo clonar paru"; exit 1
    }
    cd "$HOME_DIR/paru-src" || { echo "Error: directorio paru-src no encontrado"; exit 1; }
...
echo ""
echo ""
echo "*** GRACIAS POR CONFIAR EN ESTE HUMILDE SERVIDOR ***"
echo ""
cat <<'EOF'
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⣀⣀⣤⣼⣶⡶⠶⠾⠾⠟⠛⠛⠛⠛⠟⠿⠷⠷⢿⣶⣤⣄⣀⡀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⢄⣤⣤⡶⠿⠛⠛⠉⠉⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠉⠙⠛⠿⣶⣤⣀⡀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
